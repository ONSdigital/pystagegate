...
class TestMergedNationalProfile:
	def test_merges_final_data_and_adds_age_profiles(
		self,
		mock_national_profile_provisional_df,
		mock_national_profile_final_df,
		sex_ratio_config_no_output,
	):
		result = sex_ratio.merged_national_profile(
			mock_national_profile_provisional_df,
			mock_national_profile_final_df,
			sex_ratio_config_no_output,
		)
		...
		expected = pd.DataFrame(
			{
				...
				"imm_prov_T": [180.0, 50.0, 180.0],
				"em_prov_T": [70.0, 20.0, 70.0],
				"net_prov_T": [110.0, 30.0, 110.0],
				"imm_fin_T": [160.0, 55.0, 160.0],
				"em_fin_T": [55.0, 25.0, 55.0],
				"net_fin_T": [105.0, 30.0, 105.0],
			}
		)
